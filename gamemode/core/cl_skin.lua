...
local draw = draw
local Color = Color
local DARK_50, DARK_25, DARK_100, WHITE = Color(0,0,0,45), Color(0,0,0,35), Color(0, 0, 0, 80) Color(61,61,61)
local HIGHLIGHT = Color(14, 141, 201)


SKIN = {}

SKIN.PrintName 		= "milrp"
SKIN.Author 		= "apsys"
SKIN.DermaVersion	= 1
SKIN.fontFrame = "mrp-Elements20"
SKIN.fontTab = "mrp-Elements20"
SKIN.fontButton = "mrp-Elements20"
SKIN.Colours = table.Copy(derma.SkinList.Default.Colours)
SKIN.Colours.Window.TitleActive = Color(255, 255, 255)
SKIN.Colours.Window.TitleInactive = Color(255, 255, 255)

SKIN.Colours.Button.Normal = Color(0, 0, 0)
SKIN.Colours.Button.Hover = Color(0, 0, 0)
SKIN.Colours.Button.Down = Color(0, 0, 0)
...
local bodyCol = Color(0,140,255)
local bodyColOp = Color(15, 15, 15, 200)
...
local scrollCol = Color(48, 48, 48, 80)
...
local normalCol = Color(24, 22, 22)
...
local ccCol = Color(26, 25, 25, 130)
...
derma.DefineSkin("milrp", "Skin made by TheVingard. A nice new lick of paint for BMRP's interfaces.", SKIN)
derma.RefreshSkins()

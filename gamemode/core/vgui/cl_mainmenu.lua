...
function PANEL:Init()
    ...
    self.leavebutton:SetPos(70, 300)
    ...
    self.optionsbutton:SetPos(90, 420)
    ...
    self.changename:SetPos(100, 540)
    ...
    self.changecallsign:SetPos(100, 660)

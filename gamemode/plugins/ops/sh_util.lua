...
if GExtension then
        ...
        onRun = function(ply, arg, rawText)
            ...
            if plyTarget and ply != plyTarget then
                if ply:GE_CanBan(plyTarget:SteamID64(), time) then
                    ...
                    ply:Notify("You have banned "..plyTarget:Nick().." for "..time.." minutes.")

                    local steamid = plyTarget:SteamID64()
                    local embeds = {
                        title = "Manual ban issued",
                        description = "User was banned by a staff member.",
                        url = "https://panel.mrp-community.com/index.php?t=admin_bans&id="..steamid,
                        color = 8801791,
                        fields = {
                            {
                                name = "User",
                                value = "**"..plyTarget:Nick().."** ("..steamid..") ("..plyTarget:Nick()..")"
                            },
                            {
                                name = "Moderator",
                                value = "**"..ply:Nick().."** ("..ply:SteamID64()..")"
                            },
                            {
                                name = "Reason",
                                value = reason
    ...
    mrp.RegisterChatCommand("/ban", banCommand)
    ...
    local warnCommand = {
        ...
        onRun = function(ply, arg, rawText)
            ...
            if plyTarget and ply != plyTarget then
                ...
                ply:Notify("You have warned "..plyTarget:Nick().." for "..reason..".")
                ...
                local embeds = {
                    ...
                    url = "https://panel.mrp-community.com/index.php?t=admin_warnings&id="..steamid,
                    color = 16774400,
                    fields = {
                        {
                            name = "User",
    ...
    mrp.RegisterChatCommand("/warn", warnCommand)
end
if SERVER then
	function opsGoto(ply, pos)
		...
		ply:SetPos(mrp.FindEmptyPos(pos, {ply}, 600, 30, Vector(16, 16, 64)))
	end
...
mrp.RegisterChatCommand("/goto", gotoCommand)
...
local zoneGotoCommand = {
	...
	onRun = function(ply, arg, rawText)
		...
		for v,k in pairs(mrp.Config.Zones) do
...
mrp.RegisterChatCommand("/zgoto", zoneGotoCommand)
...
mrp.RegisterChatCommand("/bring", bringCommand)
...
mrp.RegisterChatCommand("/return", returnCommand)
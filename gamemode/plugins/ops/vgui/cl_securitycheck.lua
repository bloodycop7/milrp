...
function PANEL:Init()
	...
	sad:SetPos(15, 35)
	sad:SetSize(110, 110)
	sad:SetImage("mrp/icons/sad.png")

	local title = vgui.Create("DLabel", self)
	title:SetPos(140, 35)
	title:SetFont("mrp-Elements27-Shadow")
	...
	local link = mrp.Config.SupportURL

	local desc = vgui.Create("DLabel", self)
	desc:SetPos(140, 70)
	desc:SetSize(370, 500)
	desc:SetFont("mrp-Elements19-Shadow")
	...
	linkBtn:SetFont("mrp-Elements19-Shadow")
	linkBtn:SetText("www.support.mrp-community.com")
...
vgui.Register("mrpSecurityCheck", PANEL, "DFrame")
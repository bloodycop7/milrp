...
function PANEL:SetupUI()
	local curReport = mrp.Ops.CurReport
	...
	for v,k in pairs(mrp.Ops.Log) do
...
vgui.Register("mrpUserReportMenu", PANEL, "DFrame")

concommand.Add("mrp_userreportmenu", function()
